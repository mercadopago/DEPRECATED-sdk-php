...
<html>
	...
	<body>
		<form action="md5-generator.php" method="post" enctype="application/x-www-form-urlencoded" target="">
			<!--
			...
			<input type="hidden" name="back_url_success" value="https://www.success.com"/>
